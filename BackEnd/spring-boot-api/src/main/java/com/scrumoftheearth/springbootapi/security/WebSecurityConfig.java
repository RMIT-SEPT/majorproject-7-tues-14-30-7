...
//                    .antMatchers(HttpMethod.GET, "/api/service**").permitAll()
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:8080", "http://localhost:3000", "https://master.d2a37x6ipkc0ka.amplifyapp.com", "ec2-52-91-214-226.compute-1.amazonaws.com"));
